...
app.post("/getDependencies", function(req, res) {
    ...
    var au = require(path.join(__dirname, "src/server/Src/AngularUtils"));
    var deparray={};
...
app.get("/CreateZip", function(req, res) {
    ...
    foldername = path.join(__dirname, "src/server/specs");
    var wf = require(path.join(__dirname, "src/server/Src/WriteFactories"));
